            ...
            <div className='max-w-[420px] mx-auto py-16'>
              ...
              <div className='w-full flex flex-col py-4'>
                ...
                <form onSubmit={handleSubmit}>
                  <div className='flex w-full pt-10 py-5'>
                    ...
                    <span className='w-[10%] flex'>:</span>{
                      !editFname ? <div className='w-[50%] flex justify-between'>
                        ...
                        <input onChange={(e) => setFullname(e.target.value)} type="text" class="border-b border-gray-400 focus:outline-none focus:border-amber-600 bg-transparent" />
                  ...
                  <div className='flex w-full py-5'>
                    ...
                    <span className='w-[10%] flex'>:</span>
                    {
                      !editEmail ? <div className='w-[50%] flex justify-between'>
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} type="text" class="border-b border-gray-400 focus:outline-none focus:border-amber-600 bg-transparent" />
                  ...
                  <div className='flex w-full py-5'>
                    ...
                    <span className='w-[10%] flex'>:</span>
                    {
                      !editPhone ? <div className='w-[50%] flex justify-between'>
                        ...
                        <input onChange={(e) => setPhone(e.target.value)} type="text" class="border-b border-gray-400 focus:outline-none focus:border-amber-600 bg-transparent" />
                  ...
                  {
                    showSuccess && <div class="p-4 my-2 text-sm text-green-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                      <span class="font-medium">{success}</span>
                    </div>
                  }
                  {
                    isLoading ? <button className='bg-amber-600 py-3 my-3 rounded font-bold w-full'><svg aria-hidden="true" role="status" class="inline w-4 h-4 mr-3 text-white animate-spin dark:text-g-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
